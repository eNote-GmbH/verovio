...
void MEIOutput::WriteVerse(pugi::xml_node currentNode, Verse *verse)
{
    ...
    this->WriteVerseLike(currentNode, verse);
...
{
    assert(refrain);
    this->WriteVerseLike(currentNode, refrain);
    refrain->WriteNNumberLike(currentNode);
}

void MEIOutput::WriteVerseLike(pugi::xml_node currentNode, VerseLike *verseLike)
{
    assert(verseLike);
    this->WriteLayerElement(currentNode, verseLike);
    this->WriteOffsetInterface(currentNode, verseLike);
    verseLike->WriteColor(currentNode);
    verseLike->WriteLang(currentNode);
    verseLike->WritePlacementRelStaff(currentNode);
    verseLike->WriteTypography(currentNode);
    verseLike->WriteVoltaGroupingSym(currentNode);
}
...
bool MEIInput::ReadVerse(Object *parent, pugi::xml_node verse)
{
    ...
    this->ReadVerseLike(verse, vrvVerse);
...
bool MEIInput::ReadRefrain(Object *parent, pugi::xml_node refrain)
{
    ...
    this->ReadVerseLike(refrain, vrvRefrain);
...
void MEIInput::ReadVerseLike(pugi::xml_node element, VerseLike *verseLike)
{
    this->ReadLayerElement(element, verseLike);
    this->ReadOffsetInterface(element, verseLike);
    verseLike->ReadColor(element);
    verseLike->ReadLang(element);
    verseLike->ReadPlacementRelStaff(element);
    verseLike->ReadTypography(element);
    verseLike->ReadVoltaGroupingSym(element);
}
