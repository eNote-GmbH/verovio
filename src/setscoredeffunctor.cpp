...
FunctorCode ReplaceDrawingValuesInStaffDefFunctor::VisitStaffDef(StaffDef *staffDef)
{
    ...
    // The staffDef style takes precedence over the style of the scoreDef it belongs to
    staffDef->ReplaceTextStyle(m_newScoreDef);
    if (newStaffDef) staffDef->ReplaceTextStyle(newStaffDef);
