...
int main(int argc, char **argv)
{
    ...
    ok &= Expect(CountOccurrences(coreMei, "align=\"") == 4, "stack alignments did not round-trip");
    ...
    ok &= Expect(
        coreSvg.find("class=\"sylConnector\"") != std::string::npos, "semantic syllable hyphen was not rendered");
