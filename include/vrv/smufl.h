...
enum {
    ...
    SMUFL_ED10_fingering0 = 0xED10,
    SMUFL_ED11_fingering1 = 0xED11,
    SMUFL_ED12_fingering2 = 0xED12,
    SMUFL_ED13_fingering3 = 0xED13,
    SMUFL_ED14_fingering4 = 0xED14,
    SMUFL_ED15_fingering5 = 0xED15,
    SMUFL_ED16_fingeringTUpper = 0xED16,
    SMUFL_ED17_fingeringPLower = 0xED17,
    SMUFL_ED18_fingeringTLower = 0xED18,
    SMUFL_ED19_fingeringILower = 0xED19,
    SMUFL_ED1A_fingeringMLower = 0xED1A,
    SMUFL_ED1B_fingeringALower = 0xED1B,
    SMUFL_ED1C_fingeringCLower = 0xED1C,
    SMUFL_ED1D_fingeringXLower = 0xED1D,
    SMUFL_ED1E_fingeringELower = 0xED1E,
    SMUFL_ED1F_fingeringOLower = 0xED1F,
    SMUFL_ED20_fingeringSubstitutionAbove = 0xED20,
    SMUFL_ED21_fingeringSubstitutionBelow = 0xED21,
    SMUFL_ED22_fingeringSubstitutionDash = 0xED22,
    SMUFL_ED23_fingeringMultipleNotes = 0xED23,
    SMUFL_ED24_fingering6 = 0xED24,
    SMUFL_ED25_fingering7 = 0xED25,
    SMUFL_ED26_fingering8 = 0xED26,
    SMUFL_ED27_fingering9 = 0xED27,
    SMUFL_ED28_fingeringLeftParenthesis = 0xED28,
    SMUFL_ED29_fingeringRightParenthesis = 0xED29,
    SMUFL_ED2A_fingeringLeftBracket = 0xED2A,
    SMUFL_ED2B_fingeringRightBracket = 0xED2B,
    SMUFL_ED2C_fingeringSeparatorMiddleDot = 0xED2C,
    SMUFL_ED2D_fingeringSeparatorMiddleDotWhite = 0xED2D,
    SMUFL_ED2E_fingeringSeparatorSlash = 0xED2E,
    SMUFL_ED40_articSoftAccentAbove = 0xED40,
    SMUFL_ED41_articSoftAccentBelow = 0xED41,
    SMUFL_ED80_fingering0Italic = 0xED80,
    SMUFL_ED81_fingering1Italic = 0xED81,
    SMUFL_ED82_fingering2Italic = 0xED82,
    SMUFL_ED83_fingering3Italic = 0xED83,
    SMUFL_ED84_fingering4Italic = 0xED84,
    SMUFL_ED85_fingering5Italic = 0xED85,
    SMUFL_ED86_fingering6Italic = 0xED86,
    SMUFL_ED87_fingering7Italic = 0xED87,
    SMUFL_ED88_fingering8Italic = 0xED88,
    SMUFL_ED89_fingering9Italic = 0xED89,
    SMUFL_ED8A_fingeringLeftParenthesisItalic = 0xED8A,
    SMUFL_ED8B_fingeringRightParenthesisItalic = 0xED8B,
    SMUFL_ED8C_fingeringLeftBracketItalic = 0xED8C,
    SMUFL_ED8D_fingeringRightBracketItalic = 0xED8D,
    SMUFL_ED8E_fingeringQLower = 0xED8E,
    SMUFL_ED8F_fingeringSLower = 0xED8F,
};

/** The number of glyphs for verification **/
#define SMUFL_COUNT 668
