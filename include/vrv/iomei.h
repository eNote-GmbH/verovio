...
private:
    ...
    void WriteChordTable(pugi::xml_node currentNode, ChordTable *chordTable);
    void WriteChordDef(pugi::xml_node currentNode, ChordDef *chordDef);
    void WriteChordMember(pugi::xml_node currentNode, ChordMember *chordMember);
    void WriteBarre(pugi::xml_node currentNode, Barre *barre);
...
private:
    ...
    bool ReadChordTable(Object *parent, pugi::xml_node chordTable);
    bool ReadChordDef(Object *parent, pugi::xml_node chordDef);
    bool ReadChordMember(Object *parent, pugi::xml_node chordMember);
    bool ReadBarre(Object *parent, pugi::xml_node barre);
