...
public:
    ...
    virtual FunctorCode VisitHead(Head *head);
    virtual FunctorCode VisitHeadEnd(Head *head);
    virtual FunctorCode VisitParagraph(Paragraph *paragraph);
    virtual FunctorCode VisitParagraphEnd(Paragraph *paragraph);
    virtual FunctorCode VisitLineGroup(LineGroup *lineGroup);
    virtual FunctorCode VisitLineGroupEnd(LineGroup *lineGroup);
    virtual FunctorCode VisitLine(Line *line);
    virtual FunctorCode VisitLineEnd(Line *line);
    virtual FunctorCode VisitTable(Table *table);
    virtual FunctorCode VisitTableEnd(Table *table);
    virtual FunctorCode VisitTableCaption(TableCaption *caption);
    virtual FunctorCode VisitTableCaptionEnd(TableCaption *caption);
    virtual FunctorCode VisitTableRow(TableRow *row);
    virtual FunctorCode VisitTableRowEnd(TableRow *row);
    virtual FunctorCode VisitTd(Td *td);
    virtual FunctorCode VisitTdEnd(Td *td);
    virtual FunctorCode VisitTh(Th *th);
    virtual FunctorCode VisitThEnd(Th *th);
    ...
    virtual FunctorCode VisitTextFlowSyl(TextFlowSyl *syl);
    virtual FunctorCode VisitTextFlowSylEnd(TextFlowSyl *syl);
    ...
    virtual FunctorCode VisitStack(Stack *stack);
    virtual FunctorCode VisitStackEnd(Stack *stack);
...
public:
    ...
    virtual FunctorCode VisitHead(const Head *head);
    virtual FunctorCode VisitHeadEnd(const Head *head);
    virtual FunctorCode VisitParagraph(const Paragraph *paragraph);
    virtual FunctorCode VisitParagraphEnd(const Paragraph *paragraph);
    virtual FunctorCode VisitLineGroup(const LineGroup *lineGroup);
    virtual FunctorCode VisitLineGroupEnd(const LineGroup *lineGroup);
    virtual FunctorCode VisitLine(const Line *line);
    virtual FunctorCode VisitLineEnd(const Line *line);
    virtual FunctorCode VisitTable(const Table *table);
    virtual FunctorCode VisitTableEnd(const Table *table);
    virtual FunctorCode VisitTableCaption(const TableCaption *caption);
    virtual FunctorCode VisitTableCaptionEnd(const TableCaption *caption);
    virtual FunctorCode VisitTableRow(const TableRow *row);
    virtual FunctorCode VisitTableRowEnd(const TableRow *row);
    virtual FunctorCode VisitTd(const Td *td);
    virtual FunctorCode VisitTdEnd(const Td *td);
    virtual FunctorCode VisitTh(const Th *th);
    virtual FunctorCode VisitThEnd(const Th *th);
    ...
    virtual FunctorCode VisitTextFlowSyl(const TextFlowSyl *syl);
    virtual FunctorCode VisitTextFlowSylEnd(const TextFlowSyl *syl);
    ...
    virtual FunctorCode VisitStack(const Stack *stack);
    virtual FunctorCode VisitStackEnd(const Stack *stack);
