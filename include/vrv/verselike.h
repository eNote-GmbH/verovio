...
#ifndef __VRV_VERSELIKE_H__
#define __VRV_VERSELIKE_H__
...
class VerseLike : public LayerElement,
...
public:
    ...
    /** Add sung text or an editorial wrapper to a verse-like container. */
    ...
    /** Return the closest verse-like ancestor of an object. */
    static VerseLike *GetAncestorVerseLike(Object *object, int maxDepth = UNLIMITED_DEPTH);
    static const VerseLike *GetAncestorVerseLike(const Object *object, int maxDepth = UNLIMITED_DEPTH);
...
protected:
    explicit VerseLike(ClassId classId);
